...
test.list <- atime::atime_test_list(
  ...
  "DT[,.SD] improved in #4501" = atime::atime_test(
    ...
    Fast = "b594be79fcfd152a4bffb436dac95b2529e474ab", # Close-to-last merge commit in the PR (https://github.com/Rdatatable/data.table/pull/4501/commits) that fixes the issue 
